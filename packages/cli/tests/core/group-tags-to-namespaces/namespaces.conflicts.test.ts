        ...
        const files: $LT_TagCandidateFile[] = [
            ...
            createMockFile('src/Component2.tsx', [
                createMockTag({
                    ...
                    parameter2Text:
                        '{ namespace: "common", path: "some.structured" }',
                    parameterTranslations: {
        ...
        const files: $LT_TagCandidateFile[] = [
            createMockFile('src/Component1.tsx', [
                createMockTag({
                    ...
                    parameter2Text:
                        '{ namespace: "common", path: "page.header" }',
                    parameterTranslations: {
                        title: 'Simple Title',
                    },
                    parameterConfig: {
    ...
    it('should detect conflicts with multiple files (3+ files)', async () => {
        const files: $LT_TagCandidateFile[] = [
            createMockFile('src/Component1.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ title: "Title 1" }, { namespace: "common" })',
            ...
            createMockFile('src/Component2.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ title: "Title 2" }, { namespace: "common" })',
            ...
            createMockFile('src/Component3.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ title: "Title 3" }, { namespace: "common" })',
            ...
            createMockFile('src/Component4.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ title: "Title 4" }, { namespace: "common" })',
    ...
    it('should detect conflicts with empty values', async () => {
        const files: $LT_TagCandidateFile[] = [
            ...
            createMockFile('src/Component3.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ empty: undefined }, { namespace: "common" })',
    ...
    it('should detect different types of conflicts (path_overwrite vs type_mismatch)', async () => {
        const files: $LT_TagCandidateFile[] = [
            ...
            createMockFile('src/Component3.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ user: "Simple User" }, { namespace: "common" })',
        ...
        const files: $LT_TagCandidateFile[] = [
            ...
            createMockFile('src/Component2.tsx', [
                createMockTag({
                    ...
                    parameter1Text: '{ title: "New Title" }',
                    parameter2Text:
                        '{ namespace: "common", path: "app.header" }',
    ...
    it('should NOT detect conflicts between default namespace and different explicit namespace', async () => {
        const files: $LT_TagCandidateFile[] = [
            ...
            createMockFile('src/Component2.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ title: "Admin Title" }, { namespace: "admin" })',
    ...
    it('should detect conflicts with default namespace and complex nested paths', async () => {
        const files: $LT_TagCandidateFile[] = [
            ...
            createMockFile('src/Component2.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ title: "New Title" }, { path: "app.header" })',
                    parameter1Text: '{ title: "New Title" }',
            ...
            createMockFile('src/Component3.tsx', [
                createMockTag({
                    fullMatch:
                        'lang({ header: "Simple Header" }, { path: "app" })',
                    parameter1Text: '{ header: "Simple Header" }',
        ...
        it('should NOT detect conflicts between same values in different namespaces', async () => {
            const files: $LT_TagCandidateFile[] = [
                createMockFile('src/Component1.tsx', [
                    createMockTag({
                        fullMatch:
                            'lang({ title: "Same Title" }, { namespace: "common" })',
                ...
                createMockFile('src/Component2.tsx', [
                    createMockTag({
                        fullMatch:
                            'lang({ title: "Same Title" }, { namespace: "admin" })',
                        parameter1Text: '{ title: "Same Title" }',
                        parameter2Text: '{ namespace: "admin" }',
                        parameterTranslations: { title: 'Same Title' },
                        parameterConfig: {
        ...
        it('should NOT detect conflicts between empty values in different namespaces', async () => {
            const files: $LT_TagCandidateFile[] = [
                ...
                createMockFile('src/Component2.tsx', [
                    createMockTag({
                        fullMatch:
                            'lang({ empty: null }, { namespace: "admin" })',
                        parameter1Text: '{ empty: null }',
                        parameter2Text: '{ namespace: "admin" }',
                        parameterTranslations: { empty: null },
                        parameterConfig: {
